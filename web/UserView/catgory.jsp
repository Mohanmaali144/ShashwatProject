<%-- 
    Document   : catgory
    Created on : 28-Nov-2023, 12:22:13 pm
    Author     : NexGen
--%>
...
<header class="sticky">
  ...
  <!-- banner slidbar end ----------------------- -->
    <!-- book catlog end ------------------------------------------------------------ -->
    <div class="container">
        <center><h3>Novel</h3></center>
        
        <div class="row row-cols-lg-5 row-cols-md-3">
          <div class="col mb-4">
            <div class="card">
              <a href="#loginmodal" data-toggle="modal" data-target="#loginmodal"><img class="book" src="../img/robinsharma.jpg" class="card-img-top" alt="Book 1" ></a>
              <div class="card-body">
