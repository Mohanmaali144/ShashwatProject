...
<!-- -------------------------------------Add Manager Modal-------------------------------------------------------------------------------- -->
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          ...
          <h5 class="modal-title text-center" id="staticBackdropLabel">Add Manager</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
            <div class="modal-body">
            <div class="input-box">
        <form action="/SHASHWAT/AddManager" onsubmit="return validate()">
    <div class="input-field">
        <input type="text" class="input" id="name" name="name" onclick="checkName()" onfocus="checkName()" onkeyup="checkName()" >
            <label for="Name">Name</label>
            <span style="color: red; padding-top:-10px !important;" id="ndisplay">*</span>
    </div>
    
        <div class="input-field">
        <input type="text" class="input" id="email" name="email" onclick="checkEmail()" onfocus="checkEmail()" onkeyup="checkEmail()" >
            <label for="Email">Email</label>
            <span style="color: red;" id="edisplay">*</span>
                </div>
                <div class="input-field">
                <input type="text" class="input" id="mobile" name="mobile"  onclick="checkMobile()" onfocus="checkMobile()" onkeyup="checkMobile()">
                    ...
                    <div class="input-field">
                        <input type="text" class="input" id="address" name="address" onclick="checkAddress()" onfocus="checkAddress()" onkeyup="checkAddress()">
                        <label for="Address">Address</label>
                        <span style="color: red;" id="adisplay">*</span>
                    </div>
                    <div class="input-field">
                    <input type="text" class="input" id="password" name="password" onclick="checkPassword()" onfocus="checkPassword()" onkeyup="checkPassword()" >
