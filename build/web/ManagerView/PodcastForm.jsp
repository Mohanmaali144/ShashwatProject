<%-- 
    Document   : PodcastForm
    Created on : 30-Nov-2023, 5:47:36 pm
    Author     : HP
--%>
...
<div class="container mt-5">
    <center><h2>Add Podcast</h2></center>
 <form id="bookForm"  >
     <!-- Podcast TItle -->
     <div class="form-group">
         <label for="author">Podcast TItle</label>
         <input type="text" class="form-control" id="author" placeholder="Enter Podcast TItle" required>
     </div>
 <!-- Host Name -->
 <div class="form-group">
    <label for="Speaker">Host Name</label>
    <input type="text" class="form-control" id="Speaker" placeholder="Enter Host Name" required>
</div>

     <!-- Category -->
     <div class="form-group">
         <label for="genre">Category</label>
         <input type="text" class="form-control" id="genre" placeholder="Enter Category" required>
     </div>
     ...
     <!-- Video_url -->
     <div class="form-group">
         <label for="Audio_url">Video_url</label>
